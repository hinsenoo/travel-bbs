                        ...
                        <div class="avator">
                            <a href="javascript:;" @click="toPersonal">
                                ...
                                <div class="userName">
                                    ...
                                    <div class="time">注册时长: </div>
                                </div>
                            </a>
                        </div>
                        <div class="news">
                            <ul>
                                <li><a href="javascript:;">我的全部帖子<span>0</span></a></li>
                                <li><a href="javascript:;">我的收藏夹<span>0</span></a></li>
                                <li><a href="javascript:;">我的回复<span>0</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
